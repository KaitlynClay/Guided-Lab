...
class Summary : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras != null) {
            ...
            val txtStudent = findViewById(R.id.idTxtStudent) as TextView
            val txtPhone = findViewById(R.id.idTxtPhone) as TextView
            val txtBirthDate = findViewById(R.id.idTxtBirthDate) as TextView
            val txtDegreePlan = findViewById(R.id.idTxtDegree) as TextView
            val txtMajor = findViewById(R.id.idTxtMajor) as TextView
            val txtClassSchedule = findViewById(R.id.idTxtClassSchedule) as TextView
